...
export const resources = {
  ...
  'zh-CN': { translation: {
    ...
    touchHint: '长按文件可查看更多操作', copied: '已复制', shareConfirmTitle: '创建分享链接？', shareConfirmBody: '链接将在 7 天后失效，是否继续？', confirmCreateShareLink: '创建链接', creatingShareLink: '正在创建…', shareReadyTitle: '分享链接已生成', shareReadyBody: '获得链接的人可以在 7 天内打开这份文件。', generatedShareLink: '生成的分享链接', shareCreatedLink: '分享链接', sharePhase_compressing: '正在准备文件…', sharePhase_encrypting: '正在保护文件…', sharePhase_uploading: '正在创建链接…', sharePhase_downloading: '正在打开分享文件…', sharePhase_decrypting: '正在打开分享文件…', shareLinkCopied: '分享链接已复制', shareLinkFailed: '无法创建分享链接，请检查网络后重试。', shareLinkTooLarge: '文件太大，无法通过链接分享。', shareLinkRateLimited: '创建链接过于频繁，请一分钟后重试。', sharedFileMissing: '分享链接不完整。', sharedFileCorrupt: '分享链接无效或已损坏。', sharedFileTooLarge: '分享文件太大，无法打开。', sharedFileCompressionUnsupported: '当前浏览器无法打开此分享文件。', sharedFileUnsupportedImage: '分享链接中的图片格式不受支持。', sharedFileUnsupportedVersion: '此链接由不受支持的 Webitor 版本创建。', sharedFileNotFound: '分享链接不存在。', sharedFileExpired: '分享链接已失效。', sharedFileUnavailable: '分享链接当前不可用，请检查网络后重试。', importFailed: '部分文件无法导入。'
  } }
} as const
