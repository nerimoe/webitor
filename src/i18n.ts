...
export const resources = {
  en: { translation: {
    ...
    moveOther: 'Open in split view', close: 'Close', save: 'Save', download: 'Download', saveAs: 'Save as', share: 'Share', createShareLink: 'Create share link', shareWorkspace: 'Share documents',
  ...
  'zh-CN': { translation: {
    ...
    moveOther: '在分屏中打开', close: '关闭', save: '保存', download: '下载', saveAs: '另存为', share: '分享', createShareLink: '创建分享链接', shareWorkspace: '分享文档',
