...
export const resources = {
  en: { translation: {
    ...
    touchHint: 'Long-press files for more actions', copied: 'Copied', shareConfirmTitle: 'Create an encrypted share link?', shareConfirmBody: 'An encrypted copy will be uploaded and kept for seven days. The upload only starts after you confirm.', confirmCreateShareLink: 'Create link', creatingShareLink: 'Creating link…', shareReadyTitle: 'Share link ready', shareReadyBody: 'The file is encrypted. Anyone with this complete link can open it for seven days.', generatedShareLink: 'Generated share link', shareCreatedLink: 'Share link', sharePhase_compressing: 'Compressing file…', sharePhase_encrypting: 'Encrypting in this browser…', sharePhase_uploading: 'Uploading encrypted file…', sharePhase_downloading: 'Downloading encrypted file…', sharePhase_decrypting: 'Decrypting in this browser…', shareLinkCopied: 'Encrypted share link copied', shareLinkFailed: 'Could not create the encrypted share link. Check your connection and try again.', shareLinkTooLarge: 'Encrypted shares are limited to 2 MB.', shareLinkRateLimited: 'Too many share links were created. Try again in a minute.', sharedFileMissing: 'This encrypted share link is missing its ID or decryption key.', sharedFileCorrupt: 'The encrypted file or its decryption key is invalid.', sharedFileTooLarge: 'The encrypted file exceeds the size limit.', sharedFileCompressionUnsupported: 'This browser cannot decompress this shared file.', sharedFileUnsupportedImage: 'The shared link contains an unsupported image type.', sharedFileUnsupportedVersion: 'This share link was created by an unsupported Webitor version.', sharedFileNotFound: 'This encrypted share link does not exist.', sharedFileExpired: 'This encrypted share link has expired.', sharedFileUnavailable: 'The encrypted share service is unavailable. Check your connection and try again.', importFailed: 'Some files could not be imported.'
  } },
  'zh-CN': { translation: {
    ...
    touchHint: '长按文件可查看更多操作', copied: '已复制', shareConfirmTitle: '创建加密分享链接？', shareConfirmBody: '确认后才会上传加密副本并消耗一次请求额度，分享内容保留 7 天。', confirmCreateShareLink: '创建链接', creatingShareLink: '正在创建…', shareReadyTitle: '分享链接已生成', shareReadyBody: '文件已加密，任何获得完整链接的人都可以在 7 天内打开。', generatedShareLink: '生成的分享链接', shareCreatedLink: '分享链接', sharePhase_compressing: '正在压缩文件…', sharePhase_encrypting: '正在浏览器中加密…', sharePhase_uploading: '正在上传加密文件…', sharePhase_downloading: '正在下载加密文件…', sharePhase_decrypting: '正在浏览器中解密…', shareLinkCopied: '加密分享链接已复制', shareLinkFailed: '无法创建加密分享链接，请检查网络后重试。', shareLinkTooLarge: '加密分享文件不能超过 2 MB。', shareLinkRateLimited: '创建分享链接过于频繁，请一分钟后重试。', sharedFileMissing: '加密分享链接缺少文件 ID 或解密密钥。', sharedFileCorrupt: '加密文件或解密密钥无效。', sharedFileTooLarge: '加密分享文件超过大小限制。', sharedFileCompressionUnsupported: '当前浏览器无法解压此分享文件。', sharedFileUnsupportedImage: '分享链接中的图片格式不受支持。', sharedFileUnsupportedVersion: '此分享链接由不受支持的 Webitor 版本创建。', sharedFileNotFound: '此加密分享链接不存在。', sharedFileExpired: '此加密分享链接已过期。', sharedFileUnavailable: '加密分享服务当前不可用，请检查网络后重试。', importFailed: '部分文件无法导入。'
  } }
} as const
