...
export const resources = {
  en: { translation: {
    ...
    moveOther: 'Open in split view', close: 'Close', cancel: 'Cancel', save: 'Save', download: 'Download', saveAs: 'Save as', share: 'Share', createShareLink: 'Create share link', createPickupCode: 'Create pickup code', shareWorkspace: 'Share documents',
    ...
    install: 'Install app', offline: 'Offline ready', noFile: 'Select a file to start editing', noFileTitle: 'No document open', noFileBody: 'Choose a document from the list, or start a new one here.', closeFile: 'Close document', renameFile: 'Rename document', increaseTextSize: 'Increase text size', decreaseTextSize: 'Decrease text size', resetTextSize: 'Reset text size (current: {{size}} px)', shareQrCode: 'QR code for the share link', receivingSharedFiles: 'Opening shared files…', shareTargetFailed: 'The shared files could not be opened.',
    pickupConfirmTitle: 'Create a pickup code?', pickupConfirmBody: 'The file will be stored temporarily for 10 minutes and deleted after it is picked up. Share the code only with the recipient.', confirmCreatePickupCode: 'Create code', creatingPickupCode: 'Creating code…', pickupReadyTitle: 'Pickup code ready', pickupReadyBody: 'Enter this code on the receiving device within 10 minutes.', pickupCode: 'Pickup code', copyPickupCode: 'Copy code', pickupCodeCopied: 'Pickup code copied', pickupPhase_compressing: 'Preparing…', pickupPhase_uploading: 'Sending…', pickupPhase_downloading: 'Receiving…', pickupCreateFailed: 'Could not create a pickup code. Check your connection and try again.', pickupTooLarge: 'This file is too large to send with a pickup code.', pickupRateLimited: 'Too many pickup codes were created. Try again in a minute.',
    receivePickupTitle: 'Receive with pickup code', receivePickupBody: 'Enter the six-digit code from the sending device.', receivePickup: 'Receive file', receivingPickup: 'Receiving…', pickupInvalid: 'Enter a six-digit pickup code.', pickupNotFound: 'This pickup code does not exist, has expired, or has already been used.', pickupExpired: 'This pickup code has expired.', pickupReceiveRateLimited: 'Too many attempts. Wait a minute and try again.', pickupReceiveFailed: 'Could not receive the file. Check your connection and try again.',
  ...
  'zh-CN': { translation: {
    ...
    moveOther: '在分屏中打开', close: '关闭', cancel: '取消', save: '保存', download: '下载', saveAs: '另存为', share: '分享', createShareLink: '创建分享链接', createPickupCode: '创建取件码', shareWorkspace: '分享文档',
    ...
    install: '安装应用', offline: '已可离线使用', noFile: '选择一个文件开始编辑', noFileTitle: '没有打开的文档', noFileBody: '从左侧选择一份文档，或直接在这里开始新建。', closeFile: '关闭文档', renameFile: '重命名文档', increaseTextSize: '增大文字', decreaseTextSize: '减小文字', resetTextSize: '重置字号（当前 {{size}} px）', shareQrCode: '分享链接二维码', receivingSharedFiles: '正在打开分享文件…', shareTargetFailed: '无法打开分享的文件。',
    pickupConfirmTitle: '创建取件码？', pickupConfirmBody: '文件会在服务器临时存放 10 分钟，取件后立即删除。请只把取件码告诉接收方。', confirmCreatePickupCode: '创建取件码', creatingPickupCode: '正在创建…', pickupReadyTitle: '取件码已生成', pickupReadyBody: '请在 10 分钟内到接收设备输入此取件码。', pickupCode: '取件码', copyPickupCode: '复制取件码', pickupCodeCopied: '取件码已复制', pickupPhase_compressing: '正在准备…', pickupPhase_uploading: '正在发送…', pickupPhase_downloading: '正在接收…', pickupCreateFailed: '无法创建取件码，请检查网络后重试。', pickupTooLarge: '文件太大，无法使用取件码发送。', pickupRateLimited: '创建取件码过于频繁，请一分钟后重试。',
    receivePickupTitle: '输入取件码收件', receivePickupBody: '输入发送设备上显示的 6 位取件码。', receivePickup: '接收文件', receivingPickup: '正在接收…', pickupInvalid: '请输入 6 位取件码。', pickupNotFound: '取件码不存在、已过期或文件已被领取。', pickupExpired: '取件码已过期。', pickupReceiveRateLimited: '尝试次数过多，请一分钟后重试。', pickupReceiveFailed: '无法接收文件，请检查网络后重试。',
