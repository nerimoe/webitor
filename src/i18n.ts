...
export const resources = {
  en: { translation: {
    ...
    globalSearch: 'Search documents', searchDocuments: 'Search names and document content', noResults: 'No matching documents', searchHint: 'Use arrow keys to move and Enter to open',
    ...
    dropTree: 'Add to workspace', dropEditor: 'Add and open', unsupported: 'This looks like a binary file and was not imported.',
  ...
  'zh-CN': { translation: {
    ...
    globalSearch: '搜索文档', searchDocuments: '搜索文件名和文档内容', noResults: '没有匹配的文档', searchHint: '使用方向键移动，按 Enter 打开',
    ...
    dropTree: '添加到工作区', dropEditor: '添加并打开', unsupported: '文件可能是二进制格式，未导入。',
