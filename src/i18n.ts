...
export const resources = {
  en: { translation: {
    ...
    install: 'Install app', offline: 'Offline ready', noFile: 'Select a file to start editing', noFileTitle: 'No document open', noFileBody: 'Choose a document from the list, or start a new one here.', closeFile: 'Close document', renameFile: 'Rename document', increaseTextSize: 'Increase text size', decreaseTextSize: 'Decrease text size', resetTextSize: 'Reset text size (current: {{size}} px)', shareQrCode: 'QR code for the share link',
  ...
  'zh-CN': { translation: {
    ...
    install: '安装应用', offline: '已可离线使用', noFile: '选择一个文件开始编辑', noFileTitle: '没有打开的文档', noFileBody: '从左侧选择一份文档，或直接在这里开始新建。', closeFile: '关闭文档', renameFile: '重命名文档', increaseTextSize: '增大文字', decreaseTextSize: '减小文字', resetTextSize: '重置字号（当前 {{size}} px）', shareQrCode: '分享链接二维码',
